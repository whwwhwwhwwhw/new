...
<div class="head">
  ...
  <ul class="hav">
    <li class="line" onclick="NewPage('statics/market_department/consultTeacherWelcome.jsp')">我的桌面</li>
  </ul>
...
<div class="content">
       ...
       <ul>   
           <li ><img src="statics/common/images/tb2.png"  />
              <span>咨询量</span>
                  <dl class="sonUl">
                    <dt>管理咨询量</dt>
                     <dd class="ddDiv" onclick="NewPage('teacher/consultTeacherQuery')">查询咨询量</dd>
                      <dd class="ddDiv" onclick="NewPage('teacher/transferclassTeacher')">报审通过</dd>
           ...
           <li><img src="statics/common/images/tb3.png" />
           		...
           		<dl class="sonUl">
           			<dt>操作记录</dt>
           			<dd class="ddDiv" onclick=NewPage("oaScbOperation/OperationSelect?employee_id="+${loginUser.emp_id})>操作记录</dd>
           		</dl>
           </li>
       </ul>
   ...
   <input type="hidden" name="上次登录ip" id="ipaddress" value="${lastLoginInfo.account_login_ipaddress }">
      ...
      <iframe  id="frmright" name="frmright" src="statics/market_department/consultTeacherWelcome.jsp" frameborder="0"
