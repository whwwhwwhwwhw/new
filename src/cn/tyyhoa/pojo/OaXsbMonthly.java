...
public class OaXsbMonthly implements Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = -6245642481140262378L;
	...
	public OaXsbMonthly(Integer id, Integer studentId, Integer written,
			Integer scjd, Integer classId, String stu_number, String stu_name,
			Date createtime, Date modifytime, Date writetime) {
		super();
		this.id = id;
