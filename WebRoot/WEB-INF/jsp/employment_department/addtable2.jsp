...
<div class="rightContent">
    ...
    <div class="tabContent">
        <div class="serach">
        <form action="${pageContext.request.contextPath }/employment_department/tabletianjiaa1" method="post" >
             <input type="hidden" name="report_id" value="${oaJybReport.report_id }">
            <table cellpadding="0" cellspacing="0"  class="searchTable" border="0" style="width:80%;"  cellspacing="0">
        ...
        <div class="divTable" >
           ...
           <!--  <table width="1190" height="661" border="1" align="center">
             ...
             <table width="1201" height="825" border="1" align="center" cellspacing="0">
                    ...
                    <tr>
                        <td height="40" colspan="14" align="center" >就业部工作<span style="color: #83639B ;font-weight: bolder;">${oaJybReport.report_type}
                       <%--  <c:if test="${oaJybReport.tablestruts ==0 }">(未提交)</c:if>
                        <c:if test="${oaJybReport.tablestruts !=0 }">(已提交)</c:if> --%>
                        </span>
                    ...
                    <tr>
                        <td colspan="2" rowspan="4" align="center" valign="middle" >
                            <input type="text" style="border:0; width:100%; height:100%; text-align:center;" name="report_people" value="${oaJybReport.report_people}"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="68" >
                         ...
                         <td >
                            <input type="text" style="border:0; width:100%; height:100%; text-align:center;" value="${oaJybReport.report_people}"/>
                        </td> 
                        <td colspan="3">
            ...
            <div class="btposition2">
                <div><!-- <input type="submit" class="BackBotton" value="添加" /> -->
                 <%-- <c:if test="${oaJybReport.tablestruts ==0 }"> <input type="submit" class="saveBotton" value="提交主管" /></c:if>
                  <c:if test="${oaJybReport.tablestruts !=0 }"> <input disabled="disabled" class="saveBotton" value="提交主管" /></c:if> --%>
