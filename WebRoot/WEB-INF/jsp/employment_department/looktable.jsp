...
$(function(){
    ...
    //判断是否全选
	    ...
	    var str="<tr bgcolor='#5f9ea0'><th >编号</th><th>时间</th><th>类型</th><th>备注</th><th>管理</th></tr>";
	 ...
	 for(var i=0;i<reports.length;i++){
	    ...
	    str+="<tr><td ><a href='employment_department/jutire.html?id="+reports[i].report_id+"'>"+(i+1)+"</a></td><td>"+reports[i].report_createtime+"</td><td style='color:"+colorr+";font-weight:bolder'>"+reports[i].report_type+"</td><td >-"+reports[i].work_plan_remarks+"-</td> <td><a href='employment_department/jutire.html?id="+reports[i].report_id+"' class='edit'>查看</a></td></tr>";
	 }
	   ...
	   $.ajax({
		...
		type:"post",//请求类型
		url:"employment_department/showtable?",//请求的url
	 ...
	 if(i>count-1){break;}
	  ...
	  if(index!=count){$("#page").append("<span><a href='javascript:onclick=showinfo("+(index+1)+")'>下一页</a></span>");}
	   ...
	   else $("#page").append("<span>共0页</span>");
	 }
