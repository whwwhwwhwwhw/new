...
<link rel="stylesheet" type="text/css"
	href="statics/teach_nature_department/jzb.css/showdaily.css" />
...
<body class="body">
	<form action="">
			...
			<p>
				<div class="dailydivone">
					<ul class="dailyhead">
						...
						<li class="dailyheadli3">日期:<span><fmt:formatDate
									value="${oaJzbDailyworkcontent.entrytime }"
									pattern="yyyy-MM-dd" /></span></li>
					</ul>
				</div>
				<div class="dailydivtwo">
					<table class="tableOne">
						<c:if test="${oaJzbDailyworkcontent.afternoonjobcontent ne '1'}">
							<tr>
						...
						<c:forEach items="${oaJzbDailyschedules }"
							var="oaJzbDailyschedules">
							<tr>
								<td><fmt:formatDate
										value="${oaJzbDailyschedules.starttime }" pattern="HH:mm" />
									<fmt:formatDate value="${oaJzbDailyschedules.outtime }"
										pattern="HH:mm" /></td>
		...
		<div class="dailydivtri">
			<p>日报内容:</p>
			<textarea rows="10" readonly="readonly" cols="100"
				style="width: 800px;" placeholder="内容" name="remarks">${oaJzbDailyworkcontent.remarks }</textarea>

		</div>
		<div class="btposition1">
			<input type="button" value="返回" class="saveOut"
				style="cursor:pointer;background-color:#44bb00;width:65px;height:30px;line-height:30px;
...
float:right;margin-right: 200px" />
			<a href="${pageContext.request.contextPath }/updatedailyone"
				style="cursor:pointer;background-color:#44bb00;width:65px;height:30px;line-height:30px;
text-align:center; color:#fff;font-size:12px;font-weight:bold; border:0px; border-radius: 3px; margin-right:20px;
