...
<script type="text/javascript" src="statics/teach_nature_department/jzb.js/allstu_info.js"></script>
...
$(function(){
	  ...
	  function showDate(index){
	  	...
	  	$.post("oaJzbAllStudentlist",query,show,"json");
	  }
	  function show(data){
	  ...
	  function showPer(stuList){
	  	...
	  	for(var i = 0; i < stuList.length;i++ ){
	  		...
	  		"</td><td><a href=\"${pageContext.request.contextPath }/oaJzbAllStudentInfo/" + stuList[i].stu_Id + "\" style='width:70px;'   class='link'>查看详情</a>" + 
	  		"</td></tr>");
	  	}
	  }
	...
	function showPage(pageCount,index){
	 	...
	 	$("#pageList").append("<a href='javascript:onclick=showDate(" + pageCount + ")' >末页</a>&nbsp;&nbsp;&nbsp;");
	 	$("#pageList").append("<span>第"+index+"/"+pageCount+"页</span>");
	 }
</script>
</head>
<body>
