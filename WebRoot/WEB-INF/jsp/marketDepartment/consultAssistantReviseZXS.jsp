<!DOCTYPE html>
<%@page import="cn.tyyhoa.pojo.OaScbConsulter"%>
...
/* $(document).ready(function(){
	      $("#province").append("<option value='${consulter.province}'  selected = 'selected'>${consulter.province}</option>");     
        $("#city").append("<option value='${consulter.city}'  selected = 'selected'>${consulter.city}</option>");  
          $("#district").append("<option value='${consulter.district}'  selected = 'selected'>${consulter.district}</option>");           		
}) */
...
<div class="rightContent">
  ...
  <div class="tabContent">
    <h1 class="tabTitle">编辑咨询量</h1>
      <form action="Consultway/ReviseZXS?employee_id=${loginUser.emp_id}" method="post" >
      		...
      		<td class="tdWidth" >现住址：</td>
                <td class="tdWidth" colspan="3">
                    <div>
                    	<table border="0">
                    		<tr>
                    			<td> <select name="province" class="selectStyle" id="province" style="width: 100px;"><option value="${consulter.province}">${consulter.province}</option></select></td>
                    			<td> <select name="city" class="selectStyle" id="city" style="width: 87px;"><option value="${consulter.city}">${consulter.city}</option></select></td>
                    			<td><select name="district" class="selectStyle" id="county" style="width: 170px;"><option value="${consulter.district}">${consulter.district}</option></select></td>
        ...
        <tr>
         ...
         <td class="tdWidth">媒体名称：</td>
          <td><select class="selectStyle" name="mediaName" style="width:170px;">
           ...
           <td class="tdWidth">负责咨询师：</td>
           <td><input type="test" name="consultTeacherName" value="${consulter.consultTeacherName}" class="textStyle" style="width:160px;" readonly="readonly"/></td>
