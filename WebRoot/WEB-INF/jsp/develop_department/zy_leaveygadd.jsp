...
<body>
	<div class="rightContent">
		...
		<div class="tabContent">
			...
			<form action="develop/zy_saveleaveygadd.html?uid=${uid }"
				method="post" id="leave_form">
				<table cellpadding="0" cellspacing="0" border="0" class="addTable">
					<tr>
						<td class="tdWidth"><span>*</span>学员ID：</td>
						<td><input type="hidden" name="user_id" value="${user.id}" />
							<input type="text" class="textStyle" disabled="disabled"
							style="width:160px;" value="${user.stu_id}" /></td>
					</tr>
					<tr>
						<td class="tdWidth"><span>*</span>姓名：</td>
						<td><input type="text" class="textStyle" disabled="disabled"
							style="width:160px;" value="${user.stu_name}" /></td>

					</tr>
					<tr>
						<td class="tdWidth">联系电话：</td>
						<td><input type="text" class="textStyle" required="required"
							style="width:160px;" name="phone" value="${user.contact_way}" /></td>
					</tr>

					<tr>
						<td class="tdWidth"><span>*</span>请假开始时间：</td>
						<td><input type="date" class="dateStyle" required="required"
							style="width:160px;" name="startime" /></td>
					</tr>
					<tr>
						<td class="tdWidth"><span>*</span>请假结束时间：</td>
						<td><input type="date" class="dateStyle" required="required"
							style="width:160px;" name="endtime" /></td>
					</tr>
					<tr>
						<td class="tdWidth"><span>*</span>请假天数：</td>
						<td><input type="text" class="textStyle" required="required"
							style="width:80px;" name="days" /></td>
					</tr>
					<tr>
						<td class="tdWidth">请假类型：</td>
						<td><input type="radio" class="radioStyle"
							required="required" checked="checked" name="type" value="1" />事假&nbsp;&nbsp;&nbsp;&nbsp;
