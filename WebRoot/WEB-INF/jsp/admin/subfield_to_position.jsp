...
<script type="text/javascript">
		...
		function getsubfields(position_id) {
	        if(position_id == ""){
	        	...
	        	$.ajax({
					type:"post",
					url:"getData/subfieldsByNotPosition?position_id="+position_id,
		            datatype:"json",
		            success:function(data){
		            var data = eval("("+data+")"); 
		                var str = "";
...
<body>
	<div class="rightContent">
		...
		<div class="tabContent">
			...
			<form action="subfield/subfield_to_position" method="post">
				<table cellpadding="0" cellspacing="0" border="0" class="addTable">
					...
					<tr>
						<td class="tdWidth">功能组所属职位：</td>
						<td><select class="selectStyle" name="position_id"
							id="position_id" style="width:120px;" onchange="getsubfields(this.options[this.selectedIndex].value)">
								<option value="">--请选择--</option>
						</select></td>
					</tr>
					<tr>
