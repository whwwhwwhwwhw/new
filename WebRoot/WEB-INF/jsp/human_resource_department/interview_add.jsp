...
<body>
	<div class="rightContent">
		...
		<div class="tabContent">
			<h1 class="tabTitle">添加访谈信息</h1>
			<form action="interview_add" method="post">
				<table cellpadding="0" cellspacing="0" border="0" class="addTable">
					<!--  <tr>
                    <td class="tdWidth">访谈人：</td>
                    <td><input type="text" id="interview_person_name"  class="textStyle" style="width:160px;" placeholder="请输入姓名"  />&nbsp;&nbsp;
                    <select id="interview_person_id" name="interview_person" class="searchStyle" style="width:320px;"></select>&nbsp;&nbsp;<span id="nocun">访谈人不能为空</span>
                    </td>
                </tr> -->
					<tr>
						<td style="width: 120px;text-align: right;">访谈人部门：</td>
						<td>
						<input name="depart_id" value="${loginUser.position.depart_id}" type="hidden"/>
						<select class="selectStyle" name="depart_id2" disabled="disabled"
							id="depart_id" style="width:180px;-webkit-appearance:none;border: none;">
								<%-- <option value="">--请选择--</option>
								<c:if test="${oaRlzybDepartments != null}">
									<c:forEach var="oaRlzybDepartment"
										items="${oaRlzybDepartments }">
										<option value="${oaRlzybDepartment.depart_id }">${oaRlzybDepartment.depart_name }</option>
									</c:forEach>
								</c:if> --%>
								
								<option value="${loginUser.position.depart_id}">${loginUser.position.depart_name}</option>
						</select></td>
					</tr>
					<tr>
						<td style="text-align: right;">访谈人姓名：</td>
						<td>
						<input type="hidden" name="interview_person" value="${loginUser.emp_id }"/>
						<select class="selectStyle" disabled="disabled" name="interview_person2"
							id="interview_person" style="width:180px;-webkit-appearance:none;border: 0;">
								<option value="${loginUser.emp_id }">${loginUser.emp_name }</option>
						</select></td>
					</tr>
					<tr>
						<td style="text-align: right;">访谈人岗位：</td>
						<td><input type="hidden" id="hidden1" name="position"
							class="textStyle" /> <input type="text" id="positionName"
							name="position_id" class="textStyle"
							style="width:160px;border-style: none" readonly
							value="${loginUser.position.position_name}" /></td>
					</tr>
                    ...
                    <td><input type="text" id="emp_name" class="textStyle" style="width:160px;" placeholder="请输入姓名"  />&nbsp;&nbsp;
          			<select id="emp_id" class="searchStyle" name="emp_id"  style="width:320px;"></select>&nbsp;&nbsp;<span id="nocun2">被访谈人不能为空</span>
          		</td>
          		</tr> -->
					...
					<tr>
						<td style="text-align: right;">被访谈人部门：</td>
						<td>
							<input type="hidden" id="a_emp_department" name="depart_id2" value="${oaRlzybEmployee.emp_department }"/>
						...
						<%-- <select class="selectStyle" name="depart_id2"
							id="depart_id2" style="width:180px;">
								<option value="">--请选择--</option>
								<c:if test="${oaRlzybDepartments != null}">
									<c:forEach var="oaRlzybDepartment"
										items="${oaRlzybDepartments }">
					...
					<tr>
						<td style="text-align: right;">被访谈人姓名：</td>
						<td><input type="hidden" name="emp_id" value="${oaRlzybEmployee.emp_id }"/>
					...
					<tr>
						<td style="text-align: right;">被访谈人岗位：</td>
						<td><input type="hidden" id="a_emp_position" name="position_id2" value="${oaRlzybEmployee.emp_position }"/>
							<select class="selectStyle redBorder"
								name="emp_position" id="emp_position" style="border:none;width:160px;-webkit-appearance:none;"  disabled="disabled">
								<option value="${oaRlzybEmployee.emp_position }">${oaRlzybEmployee.emp_position }</option>
								<!-- 	<option>人事专员</option> -->
							</select>
							
							<!-- <input type="text" id="positionName2" name="position_id2"
							class="textStyle" style="width:160px;border-style: none" readonly
							value="" /> --></td>
					</tr>
					...
					<tr>
						<td style="text-align: right;">访谈时间：</td>
						<td><input type="date" name="interview_date"
							class="dateStyle" style="width:160px;" /></td>
					</tr>

					<tr>
						<td style="text-align: right;">访谈原因：</td>
						<td><input type="text" name="interview_reason"
							class="textStyle" style="width:160px;" placeholder="请输入原因" />
					</tr>
					<tr>


						<td style="text-align: right;">访谈内容：</td>
						<td><textarea name="interview_content" class="areaStyle"
								style="width:360px;"></textarea></td>
					</tr>

					<tr>
						<td style="text-align: right;">记录人：</td>
						<td><input name="interview_recorder"
							value="${loginUser.emp_name }" type="hidden" /> <select
							name="interview_recorder" disabled="disabled"
							id="interview_recorder" class="textStyle"
							style="width:160px;-webkit-appearance:none;border: 0;">
								<option value="${loginUser.emp_name }">${loginUser.emp_name }</option>
						</select></td>
