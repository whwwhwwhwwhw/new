...
function find(){
	...
	$.post("Consultway/AssistantYearSheetFind",temp,showListInfo,"json");
	
}
function showListInfo(data){
$("#YearSheet").empty();
		
	var YearTime=data.YearTime;
	$("#YearSheet").append("<tr>"
		  +"<td>"+YearTime+"年  报表统计</td>"
          +"<td>"+data.YearPhoneControllers+"</td>"
          +"<td>"+data.YearControllersDirectCome+"</td>"
          +"<td>"+data.YearAllControllers+"</td>"
          +"<td>"+data.YearPhoneControllersCome+"</td>"
          +"<td>"+data.YearAllComes+"</td>"
          +"<td>"+data.YearAllenrolls+"</td>"
          +"<td>"+data.YearAllpayStatus+"</td>"
          +"<td>"+data.YearphoneToComePercentums+"</td>"
          +"<td>"+data.YearComeToenrollPercentums+"</td>"
          +"<td>"+data.YearControllerToenrollPercentums+"</td>");
...
<div class="rightContent">
	<div class="tabs" id="tabs"  >
      ...
      <span class="spanHover" id="spanLast"  onclick="YearSheet()" >年报表</span>
  	</div>
  <div class="tabContent">
  <h1 class="tabTitle">年报表</h1>
    <div class="serach">
    <form id="formQ" action="Consultway/ToYearSheetexport"  method="post">
