...
$(function(){
 ...
 <script type="text/javascript">
    	...
    	function show(){
			...
			$.post("director/conUnWayquery",showWayList,"json");
		...
		function showWayList(data){
			...
			$(".btposition2").append("<div><input type='button' class='pooupBotton' value='解冻' onclick='moveunUseWay()'></div>"); 
		...
		$(function(){
			...
			/* 批量冻结*/
			function moveunUseWay(index){
				var arr = $("input:checkbox[name='CheckBox']:checked");
				if(arr.length==0){
					alert("请选择要解冻的方式!");
				}else{
					var result = confirm("确定将选中的方式解除冻结吗？");
					if(result==true){
		...
		function useWay() {
			window.location.href="director/conDirectorway";
		}
...
<div class="rightContent">
	<div class="tabs" id="tabs"  >
      <span class="spanOut" onclick="useWay()">有效咨询方式</span>
      <span class="spanHover" id="spanLast">失效咨询方式</span>
  	</div>
