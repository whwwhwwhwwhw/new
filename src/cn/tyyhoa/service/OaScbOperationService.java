...
public interface OaScbOperationService {
	//添加操作记录
	...
	//查询被操作人
		...
		//查询操作记录
		//查询操作记录
		List<OaScbOperation> SelectOperation(@Param("employee_idsss")String employee_id,
											@Param("currPageNo")Integer currPageNo,
											@Param("pageNo")Integer pageNo,
											@Param("Time")String Time,
											@Param("emp_name")String name,
											@Param("consulter_name")String consulter_name);
		//查询记录条数
		Integer SelectOperationCount(@Param("employee_idsss")String employee_id,
				@Param("Time")String Time,
				@Param("emp_name")String name,
				@Param("consulter_name")String consulter_name);
		//查询所有咨询师
