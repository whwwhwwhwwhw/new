...
<div class="contentConfig">
    ...
    <div class="gn_nav">
        ...
        <div class="gnmk" onclick="NewPage('Consultway/ToconsultAssistantAdd')">
            新增咨询量
        </div>
        <div class="gnmk" onclick="NewPage('Consultway/consultAssistantQuery')">
            查询咨询量
        </div>
        <div class="gnmk"  onclick="NewPage('Consultway/ToHandout')">
            分发咨询量
        </div>
        
        <div class="gnmk" onclick="NewPage('Consultway/ToconsultAssistantEnrollCheck')">
            报名审核
        </div>
        ...
        <div class="gnmk" onclick="NewPage('Consultway/ToAssistantWeekSheet')">
            周报表
        </div>
        <div class="gnmk" onclick="NewPage('Consultway/ToAssistantMonthSheet')">
            月报表
        </div>
        <div class="gnmk" onclick="NewPage('Consultway/ToAssistantYearSheet')">
            年报表
        </div>
        ...
        <div class="gnmk" onclick="xiaoxi()">
           消息盒子<span class="weidu">(<spon id="geshu">0</spon>)</span>
        </div>
    </div>
