...
<hr/>
			<div class="tabContent">
				...
				<form action="develop/leaveygadd.html" method="post" id="leave_form">
					<table cellpadding="0" cellspacing="0" border="0" class="addTable">
                    		<tr>
								<td class="tdWidth"><span>*</span>学员ID：</td>
								<td><input type="text" class="textStyle" style="width:160px;" name="user_id" value="${stu.user_id}"/></td>
							</tr>
							<tr>
								<td class="tdWidth"><span>*</span>姓名：</td>
								<td><input type="text" class="textStyle" style="width:160px;" value="${stu.stuname}"/></td>
								
							</tr>
						<tr>
							<td class="tdWidth">联系电话：</td>
							<td><input type="text" class="textStyle" style="width:160px;" name="phone" value="${stu.stucontact_way}"/></td>
						</tr>
						
						<tr>
							<td class="tdWidth"><span>*</span>请假开始时间：</td>
							<td><input type="date" class="dateStyle" style="width:160px;" name="startime"/></td>
						</tr>
						<tr>
							<td class="tdWidth"><span>*</span>请假结束时间：</td>
							<td><input type="date" class="dateStyle" style="width:160px;" name="endtime" /></td>
						</tr>
                        <tr>
							<td class="tdWidth"><span>*</span>请假天数：</td>
							<td><input type="text" class="textStyle" style="width:80px;" name="days" /></td>
						</tr>
						<tr>
							<td class="tdWidth">请假类型：</td>
							<td><input type="radio" class="radioStyle" checked="checked" name="type" value="1"/>事假&nbsp;&nbsp;&nbsp;&nbsp; 
							<input type="radio" class="radioStyle" name="type" value="2"/>病假</td>
						</tr>
						<tr>
							<td class="tdWidth">请假事由：</td>
							<td><textarea rows="5" cols="80" name="reason">
