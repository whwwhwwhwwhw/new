...
<head>
    ...
    <script type="text/javascript">
       ...
       function check(form){  
	        ...
	        var responsibleName=window.document.getElementById("responsibleName").value; 
     	  	var responsibleClass=window.document.getElementById("responsibleClass").value;
       		 
          	
            if (responsibleName =="" || responsibleClass=="" )   
            {  
...
<div class="rightContent">
    	...
    	<div class="school">
        	  <h1 class="tabTitle">新增系主任</h1>
        	  <form action="market/remarketPersonAdd"  onsubmit="return yanzheng()"   id="form" method="post" enctype="multipart/form-data">
                           ...
                           <td> <select class="selectStyle" style="width:130px;" name="specialtId" id="specialtId">
                                ...
                                <c:if test="${specialtyList !=null}">
									...
									<c:forEach var="spe" items="${specialtyList}">
										<option <c:if test="${spe.id == specialtId}">selected="selected"</c:if>
