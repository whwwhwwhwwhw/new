...
<div class="head">
  ...
  <ul class="hav">
    <li class="line" onclick='NewPage("statics/market_department/marketWelcome.jsp")'>我的桌面</li>
...
<div class="content">
       ...
       <ul>
           ...
           <li ><img src="statics/common/images/tb2.png"  />
             <span>信息量</span>
                  ...
                  <dl class="sonUl">
                    <dt>管理信息量</dt>
                    <dd class="ddDiv" onclick='NewPage("market/amarketAdd")'>新增信息量</dd>
			...
			<li><img src="statics/common/images/tb3.png" />
					...
					<dl class="sonUl">	
                    	<dt>学院管理</dt>
                    	<dd class="ddDiv" onclick='NewPage("market/amarketSchoolAdd")'>新增学院信息</dd>
   ...
   <input type="hidden" name="上次登录ip" id="ipaddress" value="${lastLoginInfo.account_login_ipaddress }">
      ...
      <iframe  id="frmright" name="frmright" src="statics/market_department/marketWelcome.jsp" frameborder="0"
