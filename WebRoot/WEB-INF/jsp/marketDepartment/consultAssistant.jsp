...
<div class="head">
  ...
  <ul class="hav">
    <li class="line" onclick="NewPage('statics/market_department/consultAssistantWelcome.jsp')">我的桌面</li>
...
<div class="content">
       ...
       <ul>
           ...
           <li ><img src="statics/common/images/tb2.png"  />
             <span>咨询量</span>
                  <dl class="sonUl">
                    <dt>管理咨询量</dt>
                     <dd class="ddDiv" onclick="NewPage('Consultway/ToconsultAssistantAdd')">新增咨询量</dd>
                     <dd class="ddDiv" onclick="NewPage('Consultway/consultAssistantQuery')">查询咨询量</dd>
                   <!--   <dd class="ddDiv" onclick=NewPage("Consultway/ToHandout")>分发咨询量</dd>
                     <dd class="ddDiv" onclick=NewPage("Consultway/ToconsultAssistantEnrollCheck")>报名审核</dd> -->
                     <!-- <dd class="ddDiv" onclick=NewPage("consultAssistantPraiseCheck.jsp")>口碑审核</dd> -->
                  </dl>
           </li>
   ...
   <div class="right">
      ...
      <iframe  id="frmright" name="frmright" src="statics/market_department/consultAssistantWelcome.jsp" frameborder="0"
