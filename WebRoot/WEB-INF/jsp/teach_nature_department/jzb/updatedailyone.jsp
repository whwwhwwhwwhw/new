...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="body">
    	...
    	<p class="dailyP">中心日报工作</p>
 		...
 		<form action="${pageContext.request.contextPath }/updatedailyviewone/${oaJzbDailyworkcontent.dailyworkcontent_id}" method="post">
 		<div class="dailydivtwo">	
 			<table class="tableOne">
 				<tr>
 					<td colspan="2" style="text-align: left;display:none;">当日主要工作:<input type="text" class="chekessf" name="theContentOfThework" value="${oaJzbDailyworkcontent.theContentOfThework }" /></td>
 				</tr>
 				<tr>
 					<td colspan="2" style="text-align: left;display:none;">上午:<input type="text" name="morningwork" value="${oaJzbDailyworkcontent.morningwork }" /></td>
 				</tr>
 				<tr>
 					<td colspan="2" style="text-align: left;display:none;">下午:<input type="text" name="afternoonjobcontent" value="${oaJzbDailyworkcontent.afternoonjobcontent }" /></td>
 				</tr>
 		...
 		<div class="dailydivtri">
 			<p>日报内容:</p>
 			<textarea rows="10" cols="100" id="wbk" placeholder="内容" name="remarks">${oaJzbDailyworkcontent.remarks }</textarea>
 		</div>   
