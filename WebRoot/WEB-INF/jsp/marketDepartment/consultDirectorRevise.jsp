...
<script type="text/javascript" src="statics/common/js/jquery-1.8.0.min.js"></script>
<script type="text/javascript" src="statics/common/js/city4.city.js"></script>
<script type="text/javascript" src="statics/common/js/city4.js"></script>
...
<div class="rightContent">
  ...
  <div class="tabContent">
    <h1 class="tabTitle">编辑咨询量</h1>
      <form action="Consultway/Revise" method="post" >
      ...
      <h2>咨询量基本信息</h2>
        <tr>
          ...
          <td><input type="radio"  value=1 name="sex"  <c:if test="${sex==1}">checked="checked"</c:if>  class="radioStyle"  disabled="disabled"/>男&nbsp;&nbsp;&nbsp;&nbsp;
          	  <input type="radio"  value=2  name="sex" <c:if test="${sex==2}">checked="checked"</c:if> class="radioStyle"  disabled="disabled"/>女</td> 
       ...
       <tr>
          ...
          <td><textarea name="comments"   cols="x"  rows="y"  style="width: 1000px ;height: 150px;  " ></textarea  ></td>
