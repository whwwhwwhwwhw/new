...
<div class="rightContent">
  <div class="tabContent">
    <h1 class="tabTitle">新增巡班问题</h1>
      <form action="${pageContext.request.contextPath }/addquestion" method="post" enctype="multipart/form-data">
      <table cellpadding="0" cellspacing="0" border="0" class="addTable">
        <tr>
          <td class="tdWidth">新增巡班问题：</td>
          <td><input name="specialty_name" type="text" class="textStyle" style="width:160px;" placeholder="请输入巡班问题" value="" /></td>
        </tr>
      </table>
