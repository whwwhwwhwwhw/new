    ...
    <h1 class="tabTitle">学生月考成绩统计</h1>
     <div class="divTable" >
       <div class="serach">
        ...
        <tr>
      <td width="50">班级：</td> <td width="150"><input type="search"  class="searchStyle" style="width:160px;"/></td>
         <td width="80"><label for="search_begindate">月考月份：</label></td> 
         <td width="100"><select class="ZY_tj" style="width:100px;height:27px;">
                  <option>第一月</option>
                  <option>第二月</option>
                  <option>第三月</option>
                  <option>第四月</option>
